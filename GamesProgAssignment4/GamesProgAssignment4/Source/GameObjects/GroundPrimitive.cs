...
namespace GamesProgAssignment4
{
    class GroundPrimitive : BasicTexturePrimitive
    {
        ...
        private void constructSingularPlane() {
            ...
            Vector3 topRight = new Vector3(position.X + tileSize, position.Y, position.Z);
            Vector3 bottomLeft = new Vector3(position.X, position.Y, position.Z + tileSize);
            Vector3 bottomRight = new Vector3(position.X + tileSize, position.Y, position.Z + tileSize);
