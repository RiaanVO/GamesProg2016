...
namespace GamesProgAssignment4
{
    class Player : GameObject
    {
        ...
        float yawRotationRate = -MathHelper.PiOver4 / 150;
        ...
        private void handleInput() {
            ...
            lookDirection = Vector3.Transform(lookDirection, Matrix.CreateFromAxisAngle(Vector3.Up, (yawRotationRate) * (mouseState.X - prevMouseState.X)));
